...
สำหรับการโชว์ตอนสัมภาษณ์ ผมเตรียมโปรเจกต์ย่อยไว้ที่ `question-02-restaurant-booking-ai/` โดยใช้ `DEMO_CHAT_PROMPT.md` สำหรับสั่ง AI ให้สร้าง API และใช้ `FRONTEND_FOLLOWUP_PROMPT.md` สำหรับสั่งเพิ่มหน้า frontend ต่อในแชทเดิม
